...
def aiHandler():
	...
	if(beginSwitch == True):
		...
		cardValues = ['cow','cow','cow','cow','eagle','eagle','eagle','eagle','ladybug','ladybug',
									'ladybug','ladybug','gold','gold','ruby','ruby','diamond','diamond']

		cardStatus = ['face down','face down','face down','face down','face down','face down',
									'face down','face down','face down','face down','face down','face down',
									'face down','face down','face down','face down','face down','face down']
		shuffle(cardValues)
